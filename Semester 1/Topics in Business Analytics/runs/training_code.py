##### First Run
%cd yolov5
# --device 0 (using GPU instead of CPU)
...
##### Third Run
%cd yolov5
# --weights yolov5l.pt (large model) on 50 epochs and reduced batch size (6)
...
# # Result: Success, time needed = approx. 6h, results not as good as expected, but achieved the highest mAP_0.5:0.95 MAX value of 0.41816, and the highest mAP_0.5:0.95 mean of 0.377881 (see descriptives)
